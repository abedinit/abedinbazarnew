                    ...
                    <div class="card col-xs-2  " style="padding: 5px;height:251px; width:182px;">
                        ...
                        <a href="{{ url('prductView') }}/{{ $v_randomProduct->slug }}" style="display: block;padding: 0px;height: 160px;overflow: hidden;" class="img-hover col-sm-12 padding-zero" href="#" id="209">
                            ...
                            <span id="productName209" class="col-sm-12 text-center" style="padding: 2px;overflow: hidden;height: 20px;font-size: 12px;display: block;color:#525252;font-weight: bold;"> {{ str_limit( $v_randomProduct->product_name, 20) }}</span>
                             ...
                             <span id="productPrice209" class="col-sm-12  col-xs-12 text-center" style="padding: 0;display: block;height: 23px;line-height:28px;color: #355088;font-size: 14px;font-weight: bold"> <del style="color:red"> {{ $v_randomProduct->price }}</del>                                             </span>
                              ...
                              <a href="{{ url('prductView') }}/{{ $v_randomProduct->slug }}"  style="background:none;border: none;margin: 0;padding: 0;font-weight:bold;color:#fff">Order </a>
